  ...
  <div id="points">70 Points </div>
    ...
    <div id="Objectives" class="collapse in"> 
     ...
     <div id="Exercise01" class="collapse in"> 
      <article class="row">
        <div class="col-lg-12">  
          <p>Download and open the Excel spreadsheet file &quot;<a href="Data.xlsx">Data.xlsx</a>&quot; <br>
      ...
      <article class="h3">
        ...
        <div id="Exercise03" class="collapse in">  
          <article class="row">
            <div class="col-lg-12">
      ...
      <article class="h3">
        ...
        <div id="Exercise04" class="collapse in">  
          <article class="row">
            <div class="col-lg-12">
      ...
      <article class="h3">
        <div class="col-lg-12"><a href="#Exercise05" class="btn btn-info" data-toggle="collapse">Exercise 5-System Improvements</a></div>
         ...
         <div id="Exercise05" class="collapse in">  
          <article class="row">
            <div class="col-lg-12">
    ...
    <div id="Exercise06" class="collapse in">
      <article class="row">
        <div class="col-lg-12"><p>For this final Exercise, and to complete this assignment please read all of these instructions.<br>
        Make sure that you have completed all the exercises by filling in your name, StarID, and answers, then pressing the Submit button while viewing this page in a web browser.<br>
        (10) 6. Then take your Excel workbook .xlsx file, and upload to the D2L 'Formative01' Assignment folder.
        </p>
        </div>
        <div>          
        <div class="col-lg-12 w3-label w3-text-blue">
        (10) 7. Assignment submission<br>
        When these tasks are complete press the Submit button below.
        This ensures that a copy of your answers are submitted to my web database.</div>  
        </div>     
      </article>
     </div>
